...
@Component({
  ...
  <div class="border border-white w-1/5 text-center my-6 space-y-3">
        <img src="assets/desktop-solid.svg" alt="desktop icon" class="h-16 w-16 mx-auto">
      ...
      <div class="border border-white w-1/5 text-center my-6 space-y-3">
        <img src="assets/tablet-solid.svg" alt="desktop icon" class="h-16 w-16 mx-auto">
      ...
      <div class="border border-white w-1/5 text-center my-6 space-y-3">
        <img src="assets/mobile-screen-button-solid.svg" alt="desktop icon" class="h-16 w-16 mx-auto">
      ...
      <div class="border border-white w-1/5 text-center my-6 space-y-3">
        <img src="assets/laptop-solid.svg" alt="desktop icon" class="h-16 w-16 mx-auto">
      ...
      <div class="border border-white w-1/5 text-center my-6 space-y-3">
        <img src="assets/microchip-solid.svg" alt="desktop icon" class="h-16 w-16 mx-auto">
      ...
      <div class="border border-white w-1/5 text-center my-6 space-y-3">
        <img src="assets/lightbulb-solid.svg" alt="desktop icon" class="h-16 w-16 mx-auto">
