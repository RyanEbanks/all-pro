...
@Component({
  ...
  template: `
  <h1 class="text-white text-3xl lg:text-6xl font-bold text-center pt-20 pb-8">Services</h1>
  <div class="flex flex-row flex-wrap justify-center space-x-2 lg:space-x-20 pb-20">
  <div class="w-1/2 lg:w-1/5 text-center my-6 lg:space-y-3">
